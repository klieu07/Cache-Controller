...
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_init_sub__TOP__0(Vtb_trace_driven___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    VL_TRACE_DECL_BUS(tracep,c+191,0,"NUM_SETS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+192,0,"NUM_WAYS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+192,0,"WORD_SEL_BITS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+193,0,"INDEX_BITS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+196,0,"TAG_BITS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+194,0,"WAY_BITS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+21,0,"index",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 3,0);
    VL_TRACE_DECL_BUS(tracep,c+22,0,"tag_in",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 23,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+197,0,"hw",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INTEGER, 31,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+197,0,"vw",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INTEGER, 31,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+198,0,"S_IDLE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 1,0);
    VL_TRACE_DECL_BUS(tracep,c+199,0,"S_WRITEBACK",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 1,0);
    VL_TRACE_DECL_BUS(tracep,c+200,0,"S_REFILL",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 1,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+201,0,"k",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INTEGER, 31,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+21,0,"index",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 3,0);
    VL_TRACE_DECL_BUS(tracep,c+22,0,"tag",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 23,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+191,0,"LINE_BYTES",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+193,0,"LATENCY",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+202,0,"NUM_LINES",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BIT(tracep,c+183,0,"clk",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+0,0,"rst_n",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
    ...
    VL_TRACE_DECL_BUS(tracep,c+193,0,"WORDS_PER_LINE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+193,0,"OFFSET_BITS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+203,0,"LINE_IDX_BITS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+204,0,"CNT_WIDTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+201,0,"wk",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INTEGER, 31,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_POP_PREFIX(tracep);
}
...
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_init_dtype_sub____0(Vtb_trace_driven___024root* vlSelf, VerilatedVcd* tracep, const char* name, uint32_t fidx, uint32_t c, VerilatedTraceSigDirection direction) {
    ...
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[8]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    ...
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[9]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BIT(tracep,c+18,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+19,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[10]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    ...
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[11]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BIT(tracep,c+22,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+23,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[12]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    ...
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[13]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BIT(tracep,c+26,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+27,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[14]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    ...
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[15]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BIT(tracep,c+30,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+31,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_POP_PREFIX(tracep);
}
...
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_init_dtype_sub____2(Vtb_trace_driven___024root* vlSelf, VerilatedVcd* tracep, const char* name, uint32_t fidx, uint32_t c, VerilatedTraceSigDirection direction) {
    ...
    VL_TRACE_PUSH_PREFIX(tracep, name, VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 15);
    VL_TRACE_PUSH_PREFIX(tracep, "[0]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+0,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_DECL_BUS(tracep,c+1,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[1]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+2,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_DECL_BUS(tracep,c+3,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[2]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+4,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_DECL_BUS(tracep,c+5,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[3]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+6,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_DECL_BUS(tracep,c+7,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[4]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+8,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_DECL_BUS(tracep,c+9,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[5]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+10,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_DECL_BUS(tracep,c+11,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[6]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+12,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_DECL_BUS(tracep,c+13,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[7]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+14,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_DECL_BUS(tracep,c+15,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[8]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+16,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_DECL_BUS(tracep,c+17,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[9]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+18,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_DECL_BUS(tracep,c+19,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[10]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+20,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_DECL_BUS(tracep,c+21,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[11]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+22,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_DECL_BUS(tracep,c+23,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[12]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+24,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_DECL_BUS(tracep,c+25,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[13]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+26,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_DECL_BUS(tracep,c+27,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[14]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+28,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_DECL_BUS(tracep,c+29,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[15]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+30,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_DECL_BUS(tracep,c+31,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 23,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_POP_PREFIX(tracep);
}
...
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_init_dtype_sub____3(Vtb_trace_driven___024root* vlSelf, VerilatedVcd* tracep, const char* name, uint32_t fidx, uint32_t c, VerilatedTraceSigDirection direction) {
    ...
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[8]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+16,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 0,0);
    VL_TRACE_DECL_BUS(tracep,c+17,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 0,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[9]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+18,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 0,0);
    VL_TRACE_DECL_BUS(tracep,c+19,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 0,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[10]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+20,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 0,0);
    VL_TRACE_DECL_BUS(tracep,c+21,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 0,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[11]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+22,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 0,0);
    VL_TRACE_DECL_BUS(tracep,c+23,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 0,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[12]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+24,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 0,0);
    VL_TRACE_DECL_BUS(tracep,c+25,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 0,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[13]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+26,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 0,0);
    VL_TRACE_DECL_BUS(tracep,c+27,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 0,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[14]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+28,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 0,0);
    VL_TRACE_DECL_BUS(tracep,c+29,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 0,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[15]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+30,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 0,0);
    VL_TRACE_DECL_BUS(tracep,c+31,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 0,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_POP_PREFIX(tracep);
}
...
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_const_0_sub_0(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+198,(0U),2);
    bufp->fullCData(oldp+199,(1U),2);
    bufp->fullCData(oldp+200,(2U),2);
    bufp->fullIData(oldp+201,(4U),32);
    bufp->fullIData(oldp+202,(0x00000100U),32);
...
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_full_dtype____0(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<CData/*0:0*/, 2>, 16>& __VdtypeVar);
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_full_dtype____1(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<CData/*0:0*/, 2>, 16>& __VdtypeVar);
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_full_dtype____2(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<IData/*23:0*/, 2>, 16>& __VdtypeVar);
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_full_dtype____3(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<CData/*0:0*/, 2>, 16>& __VdtypeVar);
...
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_full_0_sub_0(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+21,((0x0000000fU & (vlSelfRef.tb_trace_driven__DOT__cpu_addr 
                                             >> 4U))),4);
...
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_full_dtype____0(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<CData/*0:0*/, 2>, 16>& __VdtypeVar) {
    ...
    bufp->fullBit(oldp+16,(__VdtypeVar[8U][0U]));
    bufp->fullBit(oldp+17,(__VdtypeVar[8U][1U]));
    bufp->fullBit(oldp+18,(__VdtypeVar[9U][0U]));
    bufp->fullBit(oldp+19,(__VdtypeVar[9U][1U]));
    bufp->fullBit(oldp+20,(__VdtypeVar[10U][0U]));
    bufp->fullBit(oldp+21,(__VdtypeVar[10U][1U]));
    bufp->fullBit(oldp+22,(__VdtypeVar[11U][0U]));
    bufp->fullBit(oldp+23,(__VdtypeVar[11U][1U]));
    bufp->fullBit(oldp+24,(__VdtypeVar[12U][0U]));
    bufp->fullBit(oldp+25,(__VdtypeVar[12U][1U]));
    bufp->fullBit(oldp+26,(__VdtypeVar[13U][0U]));
    bufp->fullBit(oldp+27,(__VdtypeVar[13U][1U]));
    bufp->fullBit(oldp+28,(__VdtypeVar[14U][0U]));
    bufp->fullBit(oldp+29,(__VdtypeVar[14U][1U]));
    bufp->fullBit(oldp+30,(__VdtypeVar[15U][0U]));
    bufp->fullBit(oldp+31,(__VdtypeVar[15U][1U]));
}
...
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_full_dtype____2(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<IData/*23:0*/, 2>, 16>& __VdtypeVar) {
    ...
    // Body
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode + offset);
    bufp->fullIData(oldp+0,(__VdtypeVar[0U][0U]),24);
    bufp->fullIData(oldp+1,(__VdtypeVar[0U][1U]),24);
    bufp->fullIData(oldp+2,(__VdtypeVar[1U][0U]),24);
    bufp->fullIData(oldp+3,(__VdtypeVar[1U][1U]),24);
    bufp->fullIData(oldp+4,(__VdtypeVar[2U][0U]),24);
    bufp->fullIData(oldp+5,(__VdtypeVar[2U][1U]),24);
    bufp->fullIData(oldp+6,(__VdtypeVar[3U][0U]),24);
    bufp->fullIData(oldp+7,(__VdtypeVar[3U][1U]),24);
    bufp->fullIData(oldp+8,(__VdtypeVar[4U][0U]),24);
    bufp->fullIData(oldp+9,(__VdtypeVar[4U][1U]),24);
    bufp->fullIData(oldp+10,(__VdtypeVar[5U][0U]),24);
    bufp->fullIData(oldp+11,(__VdtypeVar[5U][1U]),24);
    bufp->fullIData(oldp+12,(__VdtypeVar[6U][0U]),24);
    bufp->fullIData(oldp+13,(__VdtypeVar[6U][1U]),24);
    bufp->fullIData(oldp+14,(__VdtypeVar[7U][0U]),24);
    bufp->fullIData(oldp+15,(__VdtypeVar[7U][1U]),24);
    bufp->fullIData(oldp+16,(__VdtypeVar[8U][0U]),24);
    bufp->fullIData(oldp+17,(__VdtypeVar[8U][1U]),24);
    bufp->fullIData(oldp+18,(__VdtypeVar[9U][0U]),24);
    bufp->fullIData(oldp+19,(__VdtypeVar[9U][1U]),24);
    bufp->fullIData(oldp+20,(__VdtypeVar[10U][0U]),24);
    bufp->fullIData(oldp+21,(__VdtypeVar[10U][1U]),24);
    bufp->fullIData(oldp+22,(__VdtypeVar[11U][0U]),24);
    bufp->fullIData(oldp+23,(__VdtypeVar[11U][1U]),24);
    bufp->fullIData(oldp+24,(__VdtypeVar[12U][0U]),24);
    bufp->fullIData(oldp+25,(__VdtypeVar[12U][1U]),24);
    bufp->fullIData(oldp+26,(__VdtypeVar[13U][0U]),24);
    bufp->fullIData(oldp+27,(__VdtypeVar[13U][1U]),24);
    bufp->fullIData(oldp+28,(__VdtypeVar[14U][0U]),24);
    bufp->fullIData(oldp+29,(__VdtypeVar[14U][1U]),24);
    bufp->fullIData(oldp+30,(__VdtypeVar[15U][0U]),24);
    bufp->fullIData(oldp+31,(__VdtypeVar[15U][1U]),24);
}
