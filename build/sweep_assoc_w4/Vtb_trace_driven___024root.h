...
class alignas(VL_CACHE_LINE_BYTES) Vtb_trace_driven___024root final {
  public:
    ...
    CData/*1:0*/ tb_trace_driven__DOT__dut__DOT__hit_way_r;
    CData/*1:0*/ tb_trace_driven__DOT__dut__DOT__victim_way_r;
    ...
    VlUnpacked<VlUnpacked<CData/*0:0*/, 4>, 8> tb_trace_driven__DOT__dut__DOT__valid_array;
    VlUnpacked<VlUnpacked<CData/*0:0*/, 4>, 8> tb_trace_driven__DOT__dut__DOT__dirty_array;
    VlUnpacked<VlUnpacked<IData/*24:0*/, 4>, 8> tb_trace_driven__DOT__dut__DOT__tag_array;
    VlUnpacked<VlUnpacked<VlUnpacked<IData/*31:0*/, 4>, 4>, 8> tb_trace_driven__DOT__dut__DOT__data_array;
    VlUnpacked<VlUnpacked<CData/*1:0*/, 4>, 8> tb_trace_driven__DOT__dut__DOT__lru_counter;
