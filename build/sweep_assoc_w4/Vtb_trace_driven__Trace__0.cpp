...
void Vtb_trace_driven___024root__trace_chg_dtype____0(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<CData/*0:0*/, 4>, 8>& __VdtypeVar);
void Vtb_trace_driven___024root__trace_chg_dtype____1(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<CData/*0:0*/, 4>, 8>& __VdtypeVar);
void Vtb_trace_driven___024root__trace_chg_dtype____2(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<IData/*24:0*/, 4>, 8>& __VdtypeVar);
void Vtb_trace_driven___024root__trace_chg_dtype____3(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<CData/*1:0*/, 4>, 8>& __VdtypeVar);
...
void Vtb_trace_driven___024root__trace_chg_0_sub_0(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[3U] 
        ...
        bufp->chgCData(oldp+29,(vlSelfRef.tb_trace_driven__DOT__dut__DOT__hit_way_r),2);
        bufp->chgCData(oldp+30,(vlSelfRef.tb_trace_driven__DOT__dut__DOT__victim_way_r),2);
...
void Vtb_trace_driven___024root__trace_chg_dtype____0(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<CData/*0:0*/, 4>, 8>& __VdtypeVar) {
    ...
    bufp->chgBit(oldp+8,(__VdtypeVar[2U][0U]));
    bufp->chgBit(oldp+9,(__VdtypeVar[2U][1U]));
    bufp->chgBit(oldp+10,(__VdtypeVar[2U][2U]));
    bufp->chgBit(oldp+11,(__VdtypeVar[2U][3U]));
    bufp->chgBit(oldp+12,(__VdtypeVar[3U][0U]));
    bufp->chgBit(oldp+13,(__VdtypeVar[3U][1U]));
    bufp->chgBit(oldp+14,(__VdtypeVar[3U][2U]));
    bufp->chgBit(oldp+15,(__VdtypeVar[3U][3U]));
    bufp->chgBit(oldp+16,(__VdtypeVar[4U][0U]));
    bufp->chgBit(oldp+17,(__VdtypeVar[4U][1U]));
    bufp->chgBit(oldp+18,(__VdtypeVar[4U][2U]));
    bufp->chgBit(oldp+19,(__VdtypeVar[4U][3U]));
    bufp->chgBit(oldp+20,(__VdtypeVar[5U][0U]));
    bufp->chgBit(oldp+21,(__VdtypeVar[5U][1U]));
    bufp->chgBit(oldp+22,(__VdtypeVar[5U][2U]));
    bufp->chgBit(oldp+23,(__VdtypeVar[5U][3U]));
    bufp->chgBit(oldp+24,(__VdtypeVar[6U][0U]));
    bufp->chgBit(oldp+25,(__VdtypeVar[6U][1U]));
    bufp->chgBit(oldp+26,(__VdtypeVar[6U][2U]));
    bufp->chgBit(oldp+27,(__VdtypeVar[6U][3U]));
    bufp->chgBit(oldp+28,(__VdtypeVar[7U][0U]));
    bufp->chgBit(oldp+29,(__VdtypeVar[7U][1U]));
    bufp->chgBit(oldp+30,(__VdtypeVar[7U][2U]));
    bufp->chgBit(oldp+31,(__VdtypeVar[7U][3U]));
}
...
void Vtb_trace_driven___024root__trace_chg_dtype____2(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<IData/*24:0*/, 4>, 8>& __VdtypeVar) {
    ...
    bufp->chgIData(oldp+2,(__VdtypeVar[0U][2U]),25);
    bufp->chgIData(oldp+3,(__VdtypeVar[0U][3U]),25);
    bufp->chgIData(oldp+4,(__VdtypeVar[1U][0U]),25);
    bufp->chgIData(oldp+5,(__VdtypeVar[1U][1U]),25);
    bufp->chgIData(oldp+6,(__VdtypeVar[1U][2U]),25);
    bufp->chgIData(oldp+7,(__VdtypeVar[1U][3U]),25);
    bufp->chgIData(oldp+8,(__VdtypeVar[2U][0U]),25);
    bufp->chgIData(oldp+9,(__VdtypeVar[2U][1U]),25);
    bufp->chgIData(oldp+10,(__VdtypeVar[2U][2U]),25);
    bufp->chgIData(oldp+11,(__VdtypeVar[2U][3U]),25);
    bufp->chgIData(oldp+12,(__VdtypeVar[3U][0U]),25);
    bufp->chgIData(oldp+13,(__VdtypeVar[3U][1U]),25);
    bufp->chgIData(oldp+14,(__VdtypeVar[3U][2U]),25);
    bufp->chgIData(oldp+15,(__VdtypeVar[3U][3U]),25);
    bufp->chgIData(oldp+16,(__VdtypeVar[4U][0U]),25);
    bufp->chgIData(oldp+17,(__VdtypeVar[4U][1U]),25);
    bufp->chgIData(oldp+18,(__VdtypeVar[4U][2U]),25);
    bufp->chgIData(oldp+19,(__VdtypeVar[4U][3U]),25);
    bufp->chgIData(oldp+20,(__VdtypeVar[5U][0U]),25);
    bufp->chgIData(oldp+21,(__VdtypeVar[5U][1U]),25);
    bufp->chgIData(oldp+22,(__VdtypeVar[5U][2U]),25);
    bufp->chgIData(oldp+23,(__VdtypeVar[5U][3U]),25);
    bufp->chgIData(oldp+24,(__VdtypeVar[6U][0U]),25);
    bufp->chgIData(oldp+25,(__VdtypeVar[6U][1U]),25);
    bufp->chgIData(oldp+26,(__VdtypeVar[6U][2U]),25);
    bufp->chgIData(oldp+27,(__VdtypeVar[6U][3U]),25);
    bufp->chgIData(oldp+28,(__VdtypeVar[7U][0U]),25);
    bufp->chgIData(oldp+29,(__VdtypeVar[7U][1U]),25);
    bufp->chgIData(oldp+30,(__VdtypeVar[7U][2U]),25);
    bufp->chgIData(oldp+31,(__VdtypeVar[7U][3U]),25);
}
...
void Vtb_trace_driven___024root__trace_chg_dtype____3(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<CData/*1:0*/, 4>, 8>& __VdtypeVar) {
    ...
    bufp->chgCData(oldp+8,(__VdtypeVar[2U][0U]),2);
    bufp->chgCData(oldp+9,(__VdtypeVar[2U][1U]),2);
    bufp->chgCData(oldp+10,(__VdtypeVar[2U][2U]),2);
    bufp->chgCData(oldp+11,(__VdtypeVar[2U][3U]),2);
    bufp->chgCData(oldp+12,(__VdtypeVar[3U][0U]),2);
    bufp->chgCData(oldp+13,(__VdtypeVar[3U][1U]),2);
    bufp->chgCData(oldp+14,(__VdtypeVar[3U][2U]),2);
    bufp->chgCData(oldp+15,(__VdtypeVar[3U][3U]),2);
    bufp->chgCData(oldp+16,(__VdtypeVar[4U][0U]),2);
    bufp->chgCData(oldp+17,(__VdtypeVar[4U][1U]),2);
    bufp->chgCData(oldp+18,(__VdtypeVar[4U][2U]),2);
    bufp->chgCData(oldp+19,(__VdtypeVar[4U][3U]),2);
    bufp->chgCData(oldp+20,(__VdtypeVar[5U][0U]),2);
    bufp->chgCData(oldp+21,(__VdtypeVar[5U][1U]),2);
    bufp->chgCData(oldp+22,(__VdtypeVar[5U][2U]),2);
    bufp->chgCData(oldp+23,(__VdtypeVar[5U][3U]),2);
    bufp->chgCData(oldp+24,(__VdtypeVar[6U][0U]),2);
    bufp->chgCData(oldp+25,(__VdtypeVar[6U][1U]),2);
    bufp->chgCData(oldp+26,(__VdtypeVar[6U][2U]),2);
    bufp->chgCData(oldp+27,(__VdtypeVar[6U][3U]),2);
    bufp->chgCData(oldp+28,(__VdtypeVar[7U][0U]),2);
    bufp->chgCData(oldp+29,(__VdtypeVar[7U][1U]),2);
    bufp->chgCData(oldp+30,(__VdtypeVar[7U][2U]),2);
    bufp->chgCData(oldp+31,(__VdtypeVar[7U][3U]),2);
}
