...
VL_ATTR_COLD void Vtb_trace_driven___024root___ctor_var_reset(Vtb_trace_driven___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 8; ++__Vi1) {
            vlSelf->tb_trace_driven__DOT__dut__DOT__tag_array[__Vi0][__Vi1] = VL_SCOPED_RAND_RESET_I(25, __VscopeHash, 11664759797837800195ull);
        }
    }
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 8; ++__Vi1) {
    ...
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 8; ++__Vi1) {
            vlSelf->tb_trace_driven__DOT__dut__DOT__lru_counter[__Vi0][__Vi1] = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 3225334324054896450ull);
        }
    }
    vlSelf->tb_trace_driven__DOT__dut__DOT__hit_comb_r = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 261158611476993590ull);
    vlSelf->tb_trace_driven__DOT__dut__DOT__hit_way_r = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 16482410997116152453ull);
    vlSelf->tb_trace_driven__DOT__dut__DOT__victim_way_r = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 10136221461134810343ull);
