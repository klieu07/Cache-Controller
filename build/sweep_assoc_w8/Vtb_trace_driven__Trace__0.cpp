...
void Vtb_trace_driven___024root__trace_chg_0_sub_0(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[3U] 
        ...
        bufp->chgCData(oldp+29,(vlSelfRef.tb_trace_driven__DOT__dut__DOT__hit_way_r),3);
        bufp->chgCData(oldp+30,(vlSelfRef.tb_trace_driven__DOT__dut__DOT__victim_way_r),3);
