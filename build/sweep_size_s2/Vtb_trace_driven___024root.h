...
class alignas(VL_CACHE_LINE_BYTES) Vtb_trace_driven___024root final {
  public:
    ...
    VlUnpacked<VlUnpacked<CData/*0:0*/, 2>, 2> tb_trace_driven__DOT__dut__DOT__valid_array;
    VlUnpacked<VlUnpacked<CData/*0:0*/, 2>, 2> tb_trace_driven__DOT__dut__DOT__dirty_array;
    VlUnpacked<VlUnpacked<IData/*26:0*/, 2>, 2> tb_trace_driven__DOT__dut__DOT__tag_array;
    VlUnpacked<VlUnpacked<VlUnpacked<IData/*31:0*/, 4>, 2>, 2> tb_trace_driven__DOT__dut__DOT__data_array;
    VlUnpacked<VlUnpacked<CData/*0:0*/, 2>, 2> tb_trace_driven__DOT__dut__DOT__lru_counter;
