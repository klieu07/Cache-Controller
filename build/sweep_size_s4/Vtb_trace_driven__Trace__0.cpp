...
void Vtb_trace_driven___024root__trace_chg_dtype____0(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<CData/*0:0*/, 2>, 4>& __VdtypeVar);
void Vtb_trace_driven___024root__trace_chg_dtype____1(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<CData/*0:0*/, 2>, 4>& __VdtypeVar);
void Vtb_trace_driven___024root__trace_chg_dtype____2(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<IData/*25:0*/, 2>, 4>& __VdtypeVar);
void Vtb_trace_driven___024root__trace_chg_dtype____3(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<VlUnpacked<IData/*31:0*/, 4>, 2>, 4>& __VdtypeVar);
void Vtb_trace_driven___024root__trace_chg_dtype____4(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<CData/*0:0*/, 2>, 4>& __VdtypeVar);
...
void Vtb_trace_driven___024root__trace_chg_0_sub_0(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[1U] 
        ...
        bufp->chgCData(oldp+21,((3U & (vlSelfRef.tb_trace_driven__DOT__cpu_addr 
                                       >> 4U))),2);
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[4U]))) {
        ...
        Vtb_trace_driven___024root__trace_chg_dtype____1(vlSelf, bufp, 48, vlSelfRef.tb_trace_driven__DOT__dut__DOT__dirty_array);
        Vtb_trace_driven___024root__trace_chg_dtype____2(vlSelf, bufp, 56, vlSelfRef.tb_trace_driven__DOT__dut__DOT__tag_array);
        Vtb_trace_driven___024root__trace_chg_dtype____3(vlSelf, bufp, 64, vlSelfRef.tb_trace_driven__DOT__dut__DOT__data_array);
        Vtb_trace_driven___024root__trace_chg_dtype____4(vlSelf, bufp, 96, vlSelfRef.tb_trace_driven__DOT__dut__DOT__lru_counter);
        bufp->chgCData(oldp+104,(vlSelfRef.tb_trace_driven__DOT__dut__DOT__state),2);
        bufp->chgIData(oldp+105,(vlSelfRef.tb_trace_driven__DOT__dut__DOT__si),32);
        bufp->chgIData(oldp+106,(vlSelfRef.tb_trace_driven__DOT__dut__DOT__wi),32);
        bufp->chgIData(oldp+107,(vlSelfRef.tb_trace_driven__DOT__dut__DOT__wj),32);
        bufp->chgBit(oldp+108,(vlSelfRef.tb_trace_driven__DOT__mem__DOT__busy));
        bufp->chgBit(oldp+109,(vlSelfRef.tb_trace_driven__DOT__mem__DOT__op_is_write));
        bufp->chgCData(oldp+110,(vlSelfRef.tb_trace_driven__DOT__mem__DOT__cnt),3);
        bufp->chgIData(oldp+111,(vlSelfRef.tb_trace_driven__DOT__mem__DOT__addr_latched),32);
        bufp->chgWData(oldp+112,(vlSelfRef.tb_trace_driven__DOT__mem__DOT__wdata_latched),128);
        bufp->chgCData(oldp+116,((0x000000ffU & (vlSelfRef.tb_trace_driven__DOT__mem__DOT__addr_latched 
                                                 >> 4U))),8);
        bufp->chgIData(oldp+117,(vlSelfRef.tb_trace_driven__DOT__mem__DOT__li),32);
        bufp->chgIData(oldp+118,(vlSelfRef.tb_trace_driven__DOT__mem__DOT__wj),32);
    }
    bufp->chgBit(oldp+119,(vlSelfRef.tb_trace_driven__DOT__clk));
    bufp->chgBit(oldp+120,(((IData)(vlSelfRef.tb_trace_driven__DOT__cpu_req) 
                            & ((IData)(vlSelfRef.tb_trace_driven__DOT__dut__DOT__hit_comb_r) 
                               & (0U == (IData)(vlSelfRef.tb_trace_driven__DOT__dut__DOT__state))))));
    bufp->chgIData(oldp+121,(vlSelfRef.tb_trace_driven__DOT__dut__DOT__data_array
                             [(3U & (vlSelfRef.tb_trace_driven__DOT__cpu_addr 
                                     >> 4U))][vlSelfRef.tb_trace_driven__DOT__dut__DOT__hit_way_r]
                             [(3U & (vlSelfRef.tb_trace_driven__DOT__cpu_addr 
                                     >> 2U))]),32);
    bufp->chgBit(oldp+122,(((0U != (IData)(vlSelfRef.tb_trace_driven__DOT__dut__DOT__state)) 
                            | ((~ (IData)(vlSelfRef.tb_trace_driven__DOT__dut__DOT__hit_comb_r)) 
                               & (IData)(vlSelfRef.tb_trace_driven__DOT__cpu_req)))));
    bufp->chgIData(oldp+123,(((vlSelfRef.tb_trace_driven__DOT__dut__DOT__tag_array
                               [(3U & (vlSelfRef.tb_trace_driven__DOT__cpu_addr 
                                       >> 4U))][vlSelfRef.tb_trace_driven__DOT__dut__DOT__victim_way_r] 
                               << 6U) | (0x00000030U 
                                         & vlSelfRef.tb_trace_driven__DOT__cpu_addr))),32);
    bufp->chgBit(oldp+124,(vlSelfRef.tb_trace_driven__DOT__do_op__Vstatic__was_miss));
    bufp->chgBit(oldp+125,((vlSelfRef.tb_trace_driven__DOT__dut__DOT__valid_array
                            [(3U & (vlSelfRef.tb_trace_driven__DOT__cpu_addr 
                                    >> 4U))][vlSelfRef.tb_trace_driven__DOT__dut__DOT__victim_way_r] 
...
void Vtb_trace_driven___024root__trace_chg_dtype____2(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<IData/*25:0*/, 2>, 4>& __VdtypeVar) {
    ...
    // Body
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode +  offset);
    bufp->chgIData(oldp+0,(__VdtypeVar[0U][0U]),26);
    bufp->chgIData(oldp+1,(__VdtypeVar[0U][1U]),26);
    bufp->chgIData(oldp+2,(__VdtypeVar[1U][0U]),26);
    bufp->chgIData(oldp+3,(__VdtypeVar[1U][1U]),26);
    bufp->chgIData(oldp+4,(__VdtypeVar[2U][0U]),26);
    bufp->chgIData(oldp+5,(__VdtypeVar[2U][1U]),26);
    bufp->chgIData(oldp+6,(__VdtypeVar[3U][0U]),26);
    bufp->chgIData(oldp+7,(__VdtypeVar[3U][1U]),26);
}
...
void Vtb_trace_driven___024root__trace_chg_dtype____3(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<VlUnpacked<IData/*31:0*/, 4>, 2>, 4>& __VdtypeVar) {
    ...
    bufp->chgIData(oldp+16,(__VdtypeVar[2U][0U][0U]),32);
    bufp->chgIData(oldp+17,(__VdtypeVar[2U][0U][1U]),32);
    bufp->chgIData(oldp+18,(__VdtypeVar[2U][0U][2U]),32);
    bufp->chgIData(oldp+19,(__VdtypeVar[2U][0U][3U]),32);
    bufp->chgIData(oldp+20,(__VdtypeVar[2U][1U][0U]),32);
    bufp->chgIData(oldp+21,(__VdtypeVar[2U][1U][1U]),32);
    bufp->chgIData(oldp+22,(__VdtypeVar[2U][1U][2U]),32);
    bufp->chgIData(oldp+23,(__VdtypeVar[2U][1U][3U]),32);
    bufp->chgIData(oldp+24,(__VdtypeVar[3U][0U][0U]),32);
    bufp->chgIData(oldp+25,(__VdtypeVar[3U][0U][1U]),32);
    bufp->chgIData(oldp+26,(__VdtypeVar[3U][0U][2U]),32);
    bufp->chgIData(oldp+27,(__VdtypeVar[3U][0U][3U]),32);
    bufp->chgIData(oldp+28,(__VdtypeVar[3U][1U][0U]),32);
    bufp->chgIData(oldp+29,(__VdtypeVar[3U][1U][1U]),32);
    bufp->chgIData(oldp+30,(__VdtypeVar[3U][1U][2U]),32);
    bufp->chgIData(oldp+31,(__VdtypeVar[3U][1U][3U]),32);
}
