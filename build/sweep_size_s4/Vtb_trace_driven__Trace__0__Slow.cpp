...
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_init_sub__TOP__0(Vtb_trace_driven___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    VL_TRACE_DECL_BUS(tracep,c+130,0,"HIT_TIME_CYCLES",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+131,0,"MISS_PENALTY_CYCLES",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+132,0,"TAG_BITS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+130,0,"WAY_BITS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);

    Vtb_trace_driven___024root__trace_init_dtype____0(vlSelf, tracep, "valid_array", 0, c+40, VerilatedTraceSigDirection::NONE);

    Vtb_trace_driven___024root__trace_init_dtype____1(vlSelf, tracep, "dirty_array", 0, c+48, VerilatedTraceSigDirection::NONE);

    Vtb_trace_driven___024root__trace_init_dtype____2(vlSelf, tracep, "tag_array", 0, c+56, VerilatedTraceSigDirection::NONE);

    Vtb_trace_driven___024root__trace_init_dtype____3(vlSelf, tracep, "data_array", 0, c+64, VerilatedTraceSigDirection::NONE);

    Vtb_trace_driven___024root__trace_init_dtype____4(vlSelf, tracep, "lru_counter", 0, c+96, VerilatedTraceSigDirection::NONE);
    VL_TRACE_DECL_BUS(tracep,c+21,0,"index",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 1,0);
    VL_TRACE_DECL_BUS(tracep,c+22,0,"tag_in",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 25,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+133,0,"hw",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INTEGER, 31,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+133,0,"vw",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INTEGER, 31,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+134,0,"S_IDLE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 1,0);
    VL_TRACE_DECL_BUS(tracep,c+135,0,"S_WRITEBACK",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 1,0);
    VL_TRACE_DECL_BUS(tracep,c+136,0,"S_REFILL",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 1,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+137,0,"k",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INTEGER, 31,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+21,0,"index",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 1,0);
    VL_TRACE_DECL_BUS(tracep,c+22,0,"tag",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 25,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+127,0,"LINE_BYTES",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+128,0,"LATENCY",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+138,0,"NUM_LINES",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BIT(tracep,c+119,0,"clk",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+0,0,"rst_n",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
    ...
    VL_TRACE_DECL_BUS(tracep,c+128,0,"WORDS_PER_LINE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+128,0,"OFFSET_BITS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+139,0,"LINE_IDX_BITS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+140,0,"CNT_WIDTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    ...
    VL_TRACE_DECL_BUS(tracep,c+137,0,"wk",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INTEGER, 31,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_POP_PREFIX(tracep);
}
...
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_init_dtype_sub____2(Vtb_trace_driven___024root* vlSelf, VerilatedVcd* tracep, const char* name, uint32_t fidx, uint32_t c, VerilatedTraceSigDirection direction) {
    ...
    VL_TRACE_PUSH_PREFIX(tracep, name, VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 3);
    VL_TRACE_PUSH_PREFIX(tracep, "[0]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+0,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 25,0);
    VL_TRACE_DECL_BUS(tracep,c+1,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 25,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[1]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+2,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 25,0);
    VL_TRACE_DECL_BUS(tracep,c+3,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 25,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[2]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+4,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 25,0);
    VL_TRACE_DECL_BUS(tracep,c+5,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 25,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_PUSH_PREFIX(tracep, "[3]", VerilatedTracePrefixType::ARRAY_UNPACKED, 0, 1);
    VL_TRACE_DECL_BUS(tracep,c+6,fidx,"[0]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 25,0);
    VL_TRACE_DECL_BUS(tracep,c+7,fidx,"[1]",-1, direction, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 25,0);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_POP_PREFIX(tracep);
}
...
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_const_0_sub_0(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+131,(0x00000064U),32);
    bufp->fullIData(oldp+132,(0x0000001aU),32);
    ...
    bufp->fullIData(oldp+138,(0x00000100U),32);
...
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_full_dtype____0(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<CData/*0:0*/, 2>, 4>& __VdtypeVar);
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_full_dtype____1(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<CData/*0:0*/, 2>, 4>& __VdtypeVar);
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_full_dtype____2(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<IData/*25:0*/, 2>, 4>& __VdtypeVar);
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_full_dtype____3(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<VlUnpacked<IData/*31:0*/, 4>, 2>, 4>& __VdtypeVar);
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_full_dtype____4(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<CData/*0:0*/, 2>, 4>& __VdtypeVar);
...
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_full_0_sub_0(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+21,((3U & (vlSelfRef.tb_trace_driven__DOT__cpu_addr 
                                    >> 4U))),2);
    ...
    Vtb_trace_driven___024root__trace_full_dtype____1(vlSelf, bufp, 48, vlSelfRef.tb_trace_driven__DOT__dut__DOT__dirty_array);
    Vtb_trace_driven___024root__trace_full_dtype____2(vlSelf, bufp, 56, vlSelfRef.tb_trace_driven__DOT__dut__DOT__tag_array);
    Vtb_trace_driven___024root__trace_full_dtype____3(vlSelf, bufp, 64, vlSelfRef.tb_trace_driven__DOT__dut__DOT__data_array);
    Vtb_trace_driven___024root__trace_full_dtype____4(vlSelf, bufp, 96, vlSelfRef.tb_trace_driven__DOT__dut__DOT__lru_counter);
...
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_full_dtype____2(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<IData/*25:0*/, 2>, 4>& __VdtypeVar) {
    ...
    // Body
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode + offset);
    bufp->fullIData(oldp+0,(__VdtypeVar[0U][0U]),26);
    bufp->fullIData(oldp+1,(__VdtypeVar[0U][1U]),26);
    bufp->fullIData(oldp+2,(__VdtypeVar[1U][0U]),26);
    bufp->fullIData(oldp+3,(__VdtypeVar[1U][1U]),26);
    bufp->fullIData(oldp+4,(__VdtypeVar[2U][0U]),26);
    bufp->fullIData(oldp+5,(__VdtypeVar[2U][1U]),26);
    bufp->fullIData(oldp+6,(__VdtypeVar[3U][0U]),26);
    bufp->fullIData(oldp+7,(__VdtypeVar[3U][1U]),26);
}
...
VL_ATTR_COLD void Vtb_trace_driven___024root__trace_full_dtype____3(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<VlUnpacked<IData/*31:0*/, 4>, 2>, 4>& __VdtypeVar) {
    ...
    bufp->fullIData(oldp+16,(__VdtypeVar[2U][0U][0U]),32);
    bufp->fullIData(oldp+17,(__VdtypeVar[2U][0U][1U]),32);
    bufp->fullIData(oldp+18,(__VdtypeVar[2U][0U][2U]),32);
    bufp->fullIData(oldp+19,(__VdtypeVar[2U][0U][3U]),32);
    bufp->fullIData(oldp+20,(__VdtypeVar[2U][1U][0U]),32);
    bufp->fullIData(oldp+21,(__VdtypeVar[2U][1U][1U]),32);
    bufp->fullIData(oldp+22,(__VdtypeVar[2U][1U][2U]),32);
    bufp->fullIData(oldp+23,(__VdtypeVar[2U][1U][3U]),32);
    bufp->fullIData(oldp+24,(__VdtypeVar[3U][0U][0U]),32);
    bufp->fullIData(oldp+25,(__VdtypeVar[3U][0U][1U]),32);
    bufp->fullIData(oldp+26,(__VdtypeVar[3U][0U][2U]),32);
    bufp->fullIData(oldp+27,(__VdtypeVar[3U][0U][3U]),32);
    bufp->fullIData(oldp+28,(__VdtypeVar[3U][1U][0U]),32);
    bufp->fullIData(oldp+29,(__VdtypeVar[3U][1U][1U]),32);
    bufp->fullIData(oldp+30,(__VdtypeVar[3U][1U][2U]),32);
    bufp->fullIData(oldp+31,(__VdtypeVar[3U][1U][3U]),32);
}
