...
VL_ATTR_COLD void Vtb_trace_driven___024root___eval_stl(Vtb_trace_driven___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_trace_driven___024root___eval_stl\n"); );
    Vtb_trace_driven__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD bool Vtb_trace_driven___024root___eval_phase__stl(Vtb_trace_driven___024root* vlSelf) {
    ...
    if (__VstlExecute) {
        Vtb_trace_driven___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void Vtb_trace_driven___024root___ctor_var_reset(Vtb_trace_driven___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->tb_trace_driven__DOT__dut__DOT__valid_array[__Vi0] = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16510875504064604286ull);
    }
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->tb_trace_driven__DOT__dut__DOT__dirty_array[__Vi0] = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1071377004749126779ull);
    }
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->tb_trace_driven__DOT__dut__DOT__tag_array[__Vi0] = VL_SCOPED_RAND_RESET_I(25, __VscopeHash, 11664759797837800195ull);
    }
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 4; ++__Vi1) {
            vlSelf->tb_trace_driven__DOT__dut__DOT__data_array[__Vi0][__Vi1] = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 5210989182876123311ull);
        }
    }
    vlSelf->tb_trace_driven__DOT__dut__DOT__state = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 6554261522594129441ull);
    vlSelf->tb_trace_driven__DOT__dut__DOT__hit_comb = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16890675642712131056ull);
    ...
    vlSelf->tb_trace_driven__DOT__dut__DOT__i = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 15806854496715125463ull);
    vlSelf->tb_trace_driven__DOT__dut__DOT__w = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 4773795891380916657ull);
