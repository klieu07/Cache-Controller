...
void Vtb_trace_driven___024root__trace_chg_dtype____0(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<CData/*0:0*/, 2>, 8>& __VdtypeVar);
void Vtb_trace_driven___024root__trace_chg_dtype____1(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<CData/*0:0*/, 2>, 8>& __VdtypeVar);
void Vtb_trace_driven___024root__trace_chg_dtype____2(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<IData/*24:0*/, 2>, 8>& __VdtypeVar);
void Vtb_trace_driven___024root__trace_chg_dtype____3(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp, uint32_t offset, const VlUnpacked<VlUnpacked<CData/*0:0*/, 2>, 8>& __VdtypeVar);
...
void Vtb_trace_driven___024root__trace_chg_0_sub_0(Vtb_trace_driven___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[4U]))) {
        ...
        Vtb_trace_driven___024root__trace_chg_dtype____1(vlSelf, bufp, 56, vlSelfRef.tb_trace_driven__DOT__dut__DOT__dirty_array);
        Vtb_trace_driven___024root__trace_chg_dtype____2(vlSelf, bufp, 72, vlSelfRef.tb_trace_driven__DOT__dut__DOT__tag_array);
        Vtb_trace_driven___024root__trace_chg_dtype____3(vlSelf, bufp, 88, vlSelfRef.tb_trace_driven__DOT__dut__DOT__lru_counter);
